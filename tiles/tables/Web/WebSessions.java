...
public class WebSessions extends Table {
    ...
    public WebSessions() {
        ...
        this.setColumns(new LinkedHashMap<String, ConcurrentHashMap<String, Object>>() {{
            ...
            put("Status Code", new ConcurrentHashMap<String, Object>() {{
                put("order", 4);
                put("cellDrill", new String[] {
                    "statusnum {{value}}",
                });
            ...
            put("Transaction Status", new   ConcurrentHashMap<String, Object>() {{
                put("order", 5);
                put("compare", "true");
            }});
            put("Request Version", new ConcurrentHashMap<String, Object>() {{
                put("order", 6);
                put("cellDrill", new String[] {
                    "version {{value}}",
                });
            ...
            put("Request URI", new ConcurrentHashMap<String, Object>() {{
                put("order", 8);
                put("cellDrill", new String[] {
                    "urihttp {{value}}",
                });
            }});
            put("Referer", new ConcurrentHashMap<String, Object>() {{
                put("order", 9);
                put("cellDrill", new String[] {
                    "referer {{value}}",
                });
            ...
            put("X-Forwarded-For", new ConcurrentHashMap<String, Object>() {{
                put("order", 11);
                put("cellDrill", new String[] {
                    "xff \"{{value}}\"",
                });
            ...
            put("Number Of Bytes", new ConcurrentHashMap<String, Object>() {{
                put("order", 18);
                put("compare", "number");
            }});
            put("Number of Packets", new ConcurrentHashMap<String, Object>() {{
                put("order", 19);
                put("compare", "number");
            }});
            put("Transaction Latency", new ConcurrentHashMap<String, Object>() {{
                put("order", 20);
                put("compare", "number");
            }});
        }});
